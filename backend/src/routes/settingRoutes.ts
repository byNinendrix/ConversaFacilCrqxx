...
settingRoutes.get("/settings/appearance", isAuth, SettingController.appearance);
settingRoutes.put("/settings/appearance", isAuth, SettingController.updateAppearance);
