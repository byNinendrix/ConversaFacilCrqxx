...
companyRoutes.get("/companies/:id/services", isAuth, CompanyController.listServices);
companyRoutes.get(
  "/companies/:id/services/:serviceId/slots-preview",
  isAuth,
  CompanyController.previewServiceSlots
);
...
companyRoutes.put("/companies/:id/services", isAuth, CompanyController.updateServices);
